...
f(this);if(g.data("type")===a){var m=g.data("model_id");if(!b.isUndefined(m)&&(m=tdcIFrameData.getModel(m),!b.isUndefined(m))){var k=m.get("blockUid");if(!b.isUndefined(k)){var h=tdcAdminIFrameUI.getLiveIframe(),n=h.contents().find("#"+k);n.length||(n=h.contents().find('[data-td-block-uid="'+k+'"]'));n.length&&(k={},tdcOperationUI.inRow(n)?tdcOperationUI.inRow(n)?tdcOperationUI.inColumn(n)?tdcOperationUI.inInnerRow(n)?tdcOperationUI.inInnerColumn(n)?(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=
tdcOperationUI.inRow(n),k.$currentColumn=tdcOperationUI.inColumn(n),k.$currentInnerRow=tdcOperationUI.inInnerRow(n),k.$currentInnerColumn=tdcOperationUI.inInnerColumn(n),k.$currentElement=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=tdcOperationUI.inColumn(n),k.$currentInnerRow=tdcOperationUI.inInnerRow(n),k.$currentInnerColumn=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=tdcOperationUI.inColumn(n),
k.$currentInnerRow=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=n):k.$currentZone=n,tdcSidebar._currentModel=m,n.data("model_id",m.cid),tdcSidebar.setSettings(k,!0,m),tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"),0<a.indexOf("sticky")?(0<a.indexOf("mobile")?tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"):
...
c,d,g){var m=tdcIFrameData.getFirstModelByZoneType(a);if(!b.isUndefined(m)){var k=m.get("blockUid");tdcIFrameData.removeModel(m,!0,{silent:!0});m=tdcIFrameData._getOriginalContentJSON(c);if(b.isUndefined(m)||""===m)m=[{child:[tdcShortcodeParser.parse(0,'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]')[0].child[0]],index:0,content:'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]',shortcode:{tag:"tdc_zone",type:"closed",attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}];
...
"Newspaper"===window.tdcAdminSettings.themeName&&["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,e){if(g.hasOwnProperty(a)){if(!b.isUndefined(d))var m=JSON.parse(JSON.stringify(d));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(m)&&(m={}),m.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);
b.has(d,"data")&&b.has(data,"replyJsForEval")&&tdcAdminIFrameUI.evalInIframe(d.data.replyJsForEval);b.isUndefined(m.indexPath)||tdcSidebarPanel.showShortcodeFromPath(m.indexPath)});tdcIFrameData.rebuildZone(a,g[a],c,m)}});"header"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateHeaderTemplate()}},setFooterTemplate:function(a,c,d){if(""===a)if(tdcState.isNoFooter()?tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"):tdcIFrameData.iframeContents.find(".tdc-footer-wrap").removeClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-footer-wrap").addClass("tdc-zone-invisible"),tdcSidebar.$_sidebar.find(".tdu-save-footer-template").hide(),b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot)tdcRecycle.init(),tdcRecycle.takeSnapshot();else{if("Newspaper"===window.tdcAdminSettings.themeName){if(!b.isUndefined(d))var g=JSON.parse(JSON.stringify(d));tdcIFrameData.rebuildZone("tdc_footer","[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",e,g)}}else tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-footer-wrap").removeClass("tdc-zone-invisible"),tdcSidebar.$_sidebar.find(".tdu-save-footer-template").show(),"Newspaper"===window.tdcAdminSettings.themeName&&(b.isUndefined(d)||(g=JSON.parse(JSON.stringify(d))),tdcIFrameData.rebuildZone("tdc_footer",a,c,g)),"footer"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateFooterTemplate()},_callbackShortcodeRender:function(a){b.isUndefined(a)||b.isUndefined(a.lateCallback)||(b.isUndefined(a.lateCallbackContext)?
...
l.earlyCallback.call(this):l.earlyCallback.call(l.earlyCallbackContext))};b.isUndefined(l)||b.isUndefined(l.is_snapshot)||!0!==l.is_snapshot||(f.is_snapshot=!0);f.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a);f.tries||(f.tries++,tdcJobManager.addJob(f))};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(f)}h={error:e,getShortcode:""};tdcIFrameData._checkModelData(m,h);b.isUndefined(h.error)||tdcDebug.log(h.error);h={error:e,getShortcode:""};
b.isUndefined(m.get("parentModel"))||(tdcIFrameData._checkModelData(m.get("parentModel"),h),b.isUndefined(h.error)||tdcDebug.log(h.error))}}),tdcIFrameData.TdcCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcTopCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=Backbone.View.extend({initialize:function(){this.listenTo(this.model,"change:current",this.changeCurrent);this.listenTo(this.model,"change:html",this.customRender);
